...
//ptr = "山东德州天安电子科技";
//  LCD_ClearLine(Line0);
//  Lcd_Write24X24ChineseString( 0, Line0, 0, 0, Blue, White, ptr);
  
  ptr = " BLDC FOC DRIVER V3 ";
  LCD_DisplayStringLine(Line1, ptr);

//  ptr = "交流伺服驱动演示程序";
//  LCD_ClearLine(Line1);
//  Lcd_Write24X24ChineseString( 0, Line1, 0, 0, Blue, White, ptr);
...
{ 
  ...
  { 
    TB_Set_DisplayDelay_500us(400);  //  refresh LCD every 400*5 = 200 ms
    ...
    switch(bPresent_Visualization)
    {
      ...
      case(VISUALIZATION_1):
        ...
        temp = (ADC2_RegularConvertedValueTab[0] /32) * 6;
        Display_5DigitSignedNumber(Line2, CHAR_10, temp);
...
//这里显示电位器和其他辅助变量的值
 ...
 //         LCD_SetTextColor(Green);            
        ...
        temp = ADC2_RegularConvertedValueTab[0] ;
        Display_5DigitSignedNumber(Line5, CHAR_10, temp);

		//  这里设置TFT_LCD背光亮度。
        TIM_SetCompare3(TIM4, temp - 70); 

        temp = ADC1_RegularConvertedValueTab[0] ;       
        Display_5DigitSignedNumber(Line6, CHAR_10, temp);

        temp = ADC1_RegularConvertedValueTab[2] ;      
        Display_5DigitSignedNumber(Line7, CHAR_10, temp);
