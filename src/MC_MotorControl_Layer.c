...
//测试PE14是否可以正常驱动BELL
//修改这里后，也要修改MCL_Fan_Init函数的使能时钟。
#define FAN_GPIO_PORT GPIOA
#define FAN_GPIO_PIN  GPIO_Pin_8

//测试PE14是否可以正常驱动BELL
//修改这里后，也要修改MCL_Bell_Init函数的使能时钟。
...
#define FAULT_STATE_MIN_PERMANENCY 600 //0.5msec unit  ，300MS的等待时间后，可以清除FAULT状态。
...
#define BRAKE_GPIO_PIN        GPIO_Pin_15  //刹车电阻控制
...
// reset PID's integral values
    ...
    SVPWM_1ShuntCurrentReadingCalibration(); //设定零电流偏移量
#endif  
      
    Stat_Volt_alfa_beta.qV_Component1 = 0;
    Stat_Volt_alfa_beta.qV_Component2 = 0;             
    CALC_SVPWM(Stat_Volt_alfa_beta);  //给IR2103S自举电容充电。
...
#ifdef SINGLE_SHUNT    
    // Enable the Adv Current Reading during Run state
    SVPWM_1ShuntAdvCurrentReading(ENABLE);	  //打开电流检测
#endif
}
...
* Description    : 初始化风扇驱动 (reset the related GPIO pin)
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
* Description    : 打开风扇驱动 (reset the related GPIO pin)
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
* Description    : 关闭风扇驱动 (reset the related GPIO pin)
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
* Description    : 初始化BELL驱动 (reset the related GPIO pin)	PC9
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void MCL_Bell_Init(void)
{
  ...
  /* Configure PB.8 as Output push-pull for break feature */
  GPIO_ResetBits(BELL_GPIO_PORT, BELL_GPIO_PIN);	//关闭BELL
...
* Description    : 打开BELL驱动 (reset the related GPIO pin)
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
* Description    : 关闭BELL驱动 (reset the related GPIO pin)
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
* Description    : 初始化FAULT_RESET驱动 (reset the related GPIO pin)
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
