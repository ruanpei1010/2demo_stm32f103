...
void DMA1_Channel1_IRQHandler(void)
{
     ...
     if(DMA_GetITStatus(DMA1_IT_TC1))
    {
     ...
     for(i=0;i<BufferLenght;i++)
      {
        ADC1_RegularConvertedValueTab[j++] = (uint16_t)(ADC_DualConvertedValueTab[i]>>4);
      }
      ...
      for(i=0;i<BufferLenght;i++)
      {
       ADC2_RegularConvertedValueTab[j++] = (uint16_t)(ADC_DualConvertedValueTab[i] >> 20);
      }
...
* Return         : None
*******************************************************************************/
void ADC1_2_IRQHandler(void)		//AD�ж������������AD_EOC��AD_JEOC��AD_AWD
									//����ֱ�����3�������
{
  ...
  if((ADC1->SR & ADC_FLAG_JEOC) == ADC_FLAG_JEOC)
  {
    ...
    if (SVPWMEOCEvent())   //�õ�ֱ��ĸ�ߵ�ѹ��ɢ�����¶ȵ�ADת��������ر�ADC1ת����
    {
      ...
      MCL_Calc_BusVolt();  //����ĸ�ߵ�ѹֵ��
      switch (State)
      {
          case RUN:          
            FOC_Model();  // ��������ʱ������ʸ�����ƣ������� PMSM torque and flux ������    
          break;       
    
          case START:        
          #ifdef NO_SPEED_SENSORS
           #ifdef VIEW_ENCODER_FEEDBACK
           ENC_Start_Up();	  // �޴�����ģʽ��ʼ����������ʱ��Ϊ��hStart_Up_TimeLeft_500us����ʼΪ��10S
           if ( (wGlobal_Flags & FIRST_START) != FIRST_START)
           {
             STO_Start_Up();
           }           
           #else
           STO_Start_Up();	// �޴�����ģʽ��ʼ����������ʱ��Ϊ��hStart_Up_TimeLeft_500us����ʼΪ��10S
           #endif
          #elif defined ENCODER
           ENC_Start_Up();       
          #elif defined HALL_SENSORS  // ����Ԫ��û���������̡�
           State = RUN;
          #endif       
          break; 
...
}	 // �󴥷�TIM1_BRK_IRQHandler����ͣ���жϣ���Ӧ������ߡ�
