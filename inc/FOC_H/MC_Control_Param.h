...
* Creation date      : Mon Jun 15 19:41:34 2009
...
#define PID_TORQUE_REFERENCE   (s16)1747 //(N.b: that's the reference init
				//value in both torque and speed control)

#define PID_TORQUE_KP_DEFAULT  (s16)2513
#define PID_TORQUE_KI_DEFAULT  (s16)1629
#define PID_TORQUE_KD_DEFAULT  (s16)100

/* default values for Flux control loop */
#define PID_FLUX_REFERENCE   (s16)0
#define PID_FLUX_KP_DEFAULT  (s16)2513
#define PID_FLUX_KI_DEFAULT  (s16)1629
