...
#define K1 (s32)(-21162)             /* State Observer Gain 1 */
// Values showed on LCD display must be here multiplied by 100 
#define K2 (s32)(70929)             /* State Observer Gain 2 */
...
#define FIRST_I_STARTUP           (u16) 2621
#define FINAL_I_STARTUP           (u16) 3058
...
#define SLESS_I_ALIGNMENT           (u16) 8519
